<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userregform.aspx.cs" Inherits="_Default" %>
                        ...
                        <fieldset>
                             ...
                             <div class="span6">
                                ...
                                <label>Fullname </label>
                                  <div class="span12">
                                    <asp:TextBox ID="txtfullname" class="span10 typeahead" runat="server" ></asp:TextBox>
                                </div>
                            </div>
                            </div>
                            <div class="span6">
                                <div class="control-group">
                                 <label>KYC No. </label>
                                <div class="span12">
                                    <asp:TextBox ID="txtkyc" class="span10 typeahead" runat="server" ></asp:TextBox>
                                </div>
                            </div>
                            </div>
                 <div class="span6">
                                ...
                                <div class="span12">
                                    <asp:TextBox ID="txtpassword" class="span10 typeahead" runat="server"  TextMode="Password"></asp:TextBox>
                                </div>
                            </div>
                            </div>
                              <div class="span6">
                           ...
                           <div class="span6">
                                ...
                                <div class="span12">
                                    <asp:DropDownList ID="ddluserlist" AppendDataBoundItems="true" DataValueField="utid" DataTextField="utname" class="span10 typeahead" runat="server"></asp:DropDownList>
                                </div>
                            </div>
                            </div>
                            <div class="span6">
                                ...
                                <div class="span12">
                                    <asp:TextBox ID="txtusername" class="span10 typeahead" runat="server" ></asp:TextBox>
                                </div>
                            </div>
                            </div>
                            <div class="span6">
                            ...
                            <div class="span6">
                                ...
                                <label>utid </label>
                                <div class="span12">
                                    <asp:TextBox ID="txtutid" class="span10 typeahead" runat="server" ></asp:TextBox>
                                </div>
                            </div>
                            </div>
