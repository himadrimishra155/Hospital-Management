<%@ Page Language="C#" AutoEventWireup="true" CodeFile="appointmentinfo.aspx.cs" Inherits="appointmentinfo" %>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="span12">
                                                    <asp:DropDownList ID="ddlpatient" AppendDataBoundItems="true" DataValueField="patientid" DataTextField="fullname" class="span10 typeahead" runat="server"></asp:DropDownList>
                                        ...
                                        <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="span12">
                                                    <asp:DropDownList ID="ddldoctor" AppendDataBoundItems="true" DataValueField="username" DataTextField="fullname" class="span10 typeahead" AutoPostBack="true" OnSelectedIndexChanged="ddldoctor_SelectedIndexChanged" runat="server"></asp:DropDownList>
                                        ...
                                        <div class="span6">
                                            <div class="control-group">
                                                <label>Fees </label>
                                                <div class="span12">
                                                    <asp:TextBox ID="txtfees" runat="server" CssClass="span10 typeahead" ></asp:TextBox>
                                        ...
                                        <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="span12">
                                                    <asp:DropDownList ID="ddlday" class="span10 typeahead" runat="server">
                                        ...
                                        <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="span12">
                                                    <asp:TextBox ID="txtdate" class="span10 typeahead" runat="server"></asp:TextBox>

                                                    <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="yyyy-MM-dd" TargetControlID="txtdate" TodaysDateFormat="yyyy-MM-dd" />
                                                </div>
                                            </div>
                                        </div>
